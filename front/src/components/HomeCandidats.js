            ...
            <div className="row ">
              <div className="col-md-6 col-sm-6  col-xs-12 ">
                ...
                <div style={{paddingTop: '1em', paddingBottom: '1em'}}>
                  <a className="button large btn-xl" href="https://traitdunion.typeform.com/to/xiVFgw" style={{width: '100%', display: 'inline-block', textDecoration: 'none', backgroundColor: '#0053B3', color: 'white', cursor: 'pointer', fontFamily: 'Helvetica,Arial,sans-serif', fontSize: '24px', lineHeight: '60px', textAlign: 'center', margin: 0, height: '60px', padding: '0px 40px', borderRadius: '6px', maxWidth: '100%', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', fontWeight: 'bold', WebkitFontSmoothing: 'antialiased', MozOsxFontSmoothing: 'grayscale'}} target="_blank">Je m'inscris </a>
                </div>
              </div>
                ...
                <div className="row">
                  <div className="col-md-3 col-sm-6 col-xs-12" style={{padding: '0px', margin: '1em 0 1em 0'}}>
                    ...
                    <p style={{margin: '5px'}}>Inscrivez-vous au service avec votre email, votre adresse, votre niveau de
                      ...
                      <a href="https://traitdunion.typeform.com/to/xiVFgw" style={{color: '#0053B3', textDecoration: 'underline', fontSize: '16px'}} target="_blank">Cliquez ici</a> pour vous inscrire
                    </p>
                  </div>
                  <div className="col-md-3 col-sm-6 col-xs-12" style={{padding: '0px', margin: '1em 0 1em 0'}}>
                  ...
                  <div className="col-md-3 col-sm-6 col-xs-12" style={{padding: '0px', margin: '1em 0 1em 0'}}>
                    ...
                    <p style={{margin: '5px'}}>Un métier vous intéresse? Candidatez et partez ensuite en immersion (<a href="https://clara.pole-emploi.fr/aides/detail/pmsmp?utm_source=traitdunion" target="_blank">PMSMP</a>) quelques jours. Vous continuez à toucher vos indemnités de chômage</p>
                  </div>
                  <div className="col-md-3 col-sm-6 col-xs-12" style={{padding: '0px', margin: '1em 0 1em 0'}}>
                ...
                <div className="col-md-6 col-sm-6  col-xs-12 ">
                  ...
                  <ul>
                    ...
                    <li><b>Pour trouver rapidement du travail</b> : tous les métiers qui vous seront proposés ici sont dits
                      ...
                      C'est l'assurance pour vous de revenir rapidement à l'emploi </li>
                  </ul>
                </div>
                <div className="col-md-6 col-sm-6  col-xs-12 ">
                  ...
                  <ul>
                    ...
                    <li><b>Que proposez-vous ?</b> : nous proposons de réaliser des périodes de mise en situation en milieu
                      professionnel (<a href="https://clara.pole-emploi.fr/aides/detail/pmsmp?utm_source=traitdunion" target="_blank">PMSMP</a>)
