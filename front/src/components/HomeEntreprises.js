          ...
          <div className="container">
            <div className="row ">
              <div className="col-md-6 col-sm-6  col-xs-12 ">
                ...
                <p>&nbsp; </p>
                <ul>
                  <li><b>Donnez l'envie du métier &nbsp;</b> : Il est important de donner au futur candidat une bonne image de son futur
                    métier, sans bla-bla et de façon concrète. C'est l'occasion aussi de mettre en valeur votre entreprise.
                  </li>
                  <br/>
                  <li><b>Réussir le prochain recrutement
                  </b> : dès que vous aurez un poste à pourvoir, vous pourrez reprendre contact avec les meilleurs candidats. Plus
                    d'annonce, plus d'entretien, plus de risque.
                  </li>
                  <br/>
                  <li><b>Identifiez des candidats motivés</b> : Motivation, ponctualité, comportement, curiosité, etc faites-vous un carnet
                    d'adresses des meilleurs candidats bientôt disponibles sur le marché du travail. Nos candidats sont motivés car
                    :<br/><br/>
                    <ul>
              ...
              <div className="col-md-6 col-sm-6  col-xs-12 ">
                ...
                <ul>
                  ...
                  <li><b>Est-ce que je peux choisir les profils ?</b> : Nous vous envoyons une liste de candidats, à vous de faire votre
                    choix pour en recevoir un, plusieurs ou aucun. Ils habitent à proximité de votre entreprise.
                  </li>
                  <br/>
                  <li><b>Cela dure combien de temps ?</b> : Il n’y aucune obligation de temps. Cela peut être par exemple : 1h
                    (présentation), ½ journée (découverte) ou de 1 à 5 jours (immersion en entreprise).
                  </li>
                  <br/>
                  <li><b>Il y a beaucoup de paperasse ?</b> : Non, vous aurez juste a signer avec le demandeur d'emploi et son conseiller
                    pôle emploi une "convention relative à la mise en œuvre d'une période de mise en situation en milieu professionnel" de 2
                    petites pages (<a href="https://www.formulaires.modernisation.gouv.fr/gf/cerfa_13912.do" target="_blank"
