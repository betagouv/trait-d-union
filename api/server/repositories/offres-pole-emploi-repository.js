    ...
    return [
      {
        'accessibleTH': false,
        'alternance': false,
        'appellationlibelle': 'Masseur / Masseuse kinésithérapeute',
        'competences': [
          {
            'code': '107495',
            'exigence': 'S',
          ...
          },
          {
            'code': '107496',
            'exigence': 'S',
            'libelle': 'Organiser la séance de kinésithérapie et l\'adapter'
          },
          {
            'code': '107497',
            'exigence': 'S',
            'libelle': 'Réaliser le bilan de fin d\'intervention et conseiller le patient sur l\'hygiène de vie'
          }
        ],
        'contact': {
          'coordonnees1': 'Courriel : trois-epis@mgen.fr',
          'courriel': 'trois-epis@mgen.fr',
          'nom': 'ETS SOINS SUITE ET READAPTATION 3 EPIS - - M. Cyril FARAVELON'
        },
        ...
        'formations': [
          {
            'commentaire': 'DE masseur-kinésithérapeute',
            'domaineLibelle': 'Kinésithérapie',
            'exigence': 'E',
            'niveauLibelle': 'Bac+3, Bac+4 ou équivalent'
          }
        ],
        'id': '086LGLS',
        'intitule': 'Masseur / Masseuse kinésithérapeute',
        'langues': [],
        'lieuTravail': {
          'codePostal': '68410',
          'latitude': 48.12555555,
          'libelle': '68 - AMMERSCHWIHR',
          'longitude': 7.281944443
        },
        ...
        'origineOffre': {
          'origine': '1',
          'partenaires': [],
          'urlOrigine': 'https://candidat.pole-emploi.fr/offres/recherche/detail/086LGLS'
        },
        'qualificationCode': '7',
        ...
        'romeCode': 'J1404',
        'romeLibelle': 'Kinésithérapie',
        'salaire': {
          'complement1': 'Restauration',
          'libelle': 'Mensuel de 2354 Euros sur 12 mois'
        },
        'secteurActivite': '86',
